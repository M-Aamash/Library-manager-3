...
def load_library():
    """Loads library data from a file, or returns an empty list if file doesn't exist."""
    if os.path.exists(data_file):
        with open(data_file, "r") as file:
            return json.load(file)
    return []  # Moved outside if block
...
def remove_book(library):
    """Removes a book by title from the library."""
...
def display_statistics(library):
    """Displays statistics about the books in the library."""
